...
def configure(conf):
    ...
    conf.env.append_unique('CFLAGS', '-I/usr/src/linux-headers-5.0.0-36/include/linux')
    conf.env.append_unique('CFLAGS', '-I./linux/avbmcl/libbpf')
    #conf.env.append_unique('CFLAGS', '-I/usr/src/linux-headers-5.0.0-37/include/uapi/linux/')
